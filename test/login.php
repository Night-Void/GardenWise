            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                  <img src="gard_login.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
                </div>
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                  ...
                  <form action="index.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type="submit" class="btn btn-success btn-lg text-light py-3" name="login" style="width:100%; border-radius:30px; font-weight:600;">Login</button>
                    </div>
                  </form>
                  <p class="text-center">Don't have an account? <a href="register.php" class="text-success" style="font-weight:600;text-decoration:none;">Register Here</a></p>
                </div>
              </div>
            </div>
          </div>
